...
- If we were to do further analysis we would look at previous years data to see if fertility rate and median age were also the main contributors to population change or if 2020 was anomaly potentially due to the Covid-19 pandemic.
